...
public partial class Default11 : System.Web.UI.Page
{
    ...
    {
        c.Open();
        cm = new SqlCommand("update bank set amount=amount+'" + TextBox3.Text + "' where accno='" + TextBox1.Text + "' and pwd='" + TextBox2.Text + "'", c);
        cm.ExecuteNonQuery();
        Response.Write("<script>alert('Deposited')</script>");
        c.Close();
